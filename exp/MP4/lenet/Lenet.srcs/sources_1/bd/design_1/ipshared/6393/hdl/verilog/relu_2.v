...
wire  signed [8:0] tmp_43_cast_fu_138_p1;
reg  signed [8:0] tmp_43_cast_reg_268;
wire   [0:0] exitcond2_fu_96_p2;
wire   [3:0] j_7_fu_148_p2;
reg   [3:0] j_7_reg_276;
wire    ap_CS_fsm_state3;
wire   [11:0] tmp_31_fu_187_p2;
reg   [11:0] tmp_31_reg_281;
...
wire   [63:0] tmp_48_cast_fu_214_p1;
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_193_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        output_addr_reg_294 <= tmp_48_cast_fu_214_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond1_fu_142_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        tmp_31_reg_281[11 : 1] <= tmp_31_fu_187_p2[11 : 1];
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond2_fu_96_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_43_cast_reg_268[8 : 1] <= tmp_43_cast_fu_138_p1[8 : 1];
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        output_r_address0 = tmp_48_cast_fu_214_p1;
    end else begin
...
assign notrhs_fu_242_p2 = ((tmp_18_fu_232_p1 == 23'd0) ? 1'b1 : 1'b0);
...
assign p_shl2_cast_fu_167_p3 = {{tmp_16_fu_163_p1}, {4'd0}};
...
assign tmp_16_fu_163_p1 = tmp_30_fu_158_p2[7:0];

assign tmp_17_fu_175_p3 = {{tmp_30_fu_158_p2}, {1'd0}};

assign tmp_18_fu_232_p1 = output_load_to_int_fu_219_p1[22:0];

assign tmp_29_fu_132_p2 = (p_shl_cast_fu_116_p1 - p_shl1_cast_fu_128_p1);

assign tmp_30_fu_158_p2 = ($signed(tmp_43_cast_reg_268) + $signed(tmp_cast_fu_154_p1));

assign tmp_31_fu_187_p2 = ($signed(p_shl2_cast_fu_167_p3) - $signed(p_shl3_cast_fu_183_p1));

assign tmp_32_fu_209_p2 = (tmp_31_reg_281 + tmp_9_cast_fu_205_p1);

assign tmp_43_cast_fu_138_p1 = $signed(tmp_29_fu_132_p2);

assign tmp_48_cast_fu_214_p1 = tmp_32_fu_209_p2;
...
always @ (posedge ap_clk) begin
    tmp_43_cast_reg_268[0] <= 1'b0;
    tmp_31_reg_281[0] <= 1'b0;
end
