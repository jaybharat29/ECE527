...
wire   [0:0] tmp_18_fu_248_p2;
wire   [0:0] tmp_19_fu_91_p2;
reg   [5:0] ap_NS_fsm;
...
always @ (*) begin
    if (((tmp_20_fu_254_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state6))) begin
        output_r_we0 = 1'b1;
    end else begin
        output_r_we0 = 1'b0;
    end
...
assign i_12_fu_102_p2 = (i_reg_58 + 3'd1);

assign j_8_fu_148_p2 = (j_reg_69 + 5'd1);

assign k_7_fu_199_p2 = (k_reg_80 + 5'd1);

assign notlhs_fu_236_p2 = ((tmp_16_fu_222_p4 != 8'd255) ? 1'b1 : 1'b0);

assign notrhs_fu_242_p2 = ((tmp_23_fu_232_p1 == 23'd0) ? 1'b1 : 1'b0);
...
assign tmp_16_fu_222_p4 = {{output_load_to_int_fu_219_p1[30:23]}};

assign tmp_18_fu_248_p2 = (notrhs_fu_242_p2 | notlhs_fu_236_p2);
