...
#ifndef __conv1_fcmp_32ns_3dEe__HH__
#define __conv1_fcmp_32ns_3dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv1_fcmp_32ns_3dEe) {
    ...
    SC_CTOR(conv1_fcmp_32ns_3dEe):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
