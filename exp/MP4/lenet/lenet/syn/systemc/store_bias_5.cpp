...
const sc_logic store_bias_5::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic store_bias_5::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<9> store_bias_5::ap_ST_fsm_state1 = "1";
const sc_lv<9> store_bias_5::ap_ST_fsm_state2 = "10";
const sc_lv<9> store_bias_5::ap_ST_fsm_state3 = "100";
const sc_lv<9> store_bias_5::ap_ST_fsm_state4 = "1000";
const sc_lv<9> store_bias_5::ap_ST_fsm_state5 = "10000";
const sc_lv<9> store_bias_5::ap_ST_fsm_state6 = "100000";
const sc_lv<9> store_bias_5::ap_ST_fsm_state7 = "1000000";
const sc_lv<9> store_bias_5::ap_ST_fsm_state8 = "10000000";
const sc_lv<9> store_bias_5::ap_ST_fsm_state9 = "100000000";
const sc_lv<32> store_bias_5::ap_const_lv32_0 = "00000000000000000000000000000000";
const sc_lv<1> store_bias_5::ap_const_lv1_0 = "0";
const sc_lv<3> store_bias_5::ap_const_lv3_0 = "000";
const sc_lv<2> store_bias_5::ap_const_lv2_0 = "00";
const sc_lv<4> store_bias_5::ap_const_lv4_0 = "0000";
const sc_lv<32> store_bias_5::ap_const_lv32_7 = "111";
const sc_lv<7> store_bias_5::ap_const_lv7_0 = "0000000";
const sc_lv<32> store_bias_5::ap_const_lv32_6 = "110";
const sc_lv<32> store_bias_5::ap_const_lv32_8 = "1000";
const sc_lv<32> store_bias_5::ap_const_lv32_78 = "1111000";
const sc_lv<7> store_bias_5::ap_const_lv7_78 = "1111000";
const sc_lv<7> store_bias_5::ap_const_lv7_1 = "1";
const sc_lv<1> store_bias_5::ap_const_lv1_1 = "1";
const bool store_bias_5::ap_const_boolean_1 = true;

store_bias_5::store_bias_5(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_i_6_fu_100_p2);
    sensitive << ( i_reg_71 );
    ...
    apTFilenSS << "store_bias_5_sc_trace_" << apTFileNum ++;
    ...
    sc_trace(mVcdFile, i_6_fu_100_p2, "i_6_fu_100_p2");
    sc_trace(mVcdFile, i_6_reg_120, "i_6_reg_120");
...
store_bias_5::~store_bias_5() {
    if (mVcdFile) 
        sc_close_vcd_trace_file(mVcdFile);

}

void store_bias_5::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        i_reg_71 = i_6_reg_120.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        i_reg_71 = ap_const_lv7_0;
    }
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && !(esl_seteq<1,1,1>(exitcond_fu_94_p2.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(m_axi_bias_RVALID.read(), ap_const_logic_0)))) {
        i_6_reg_120 = i_6_fu_100_p2.read();
    }
}

void store_bias_5::thread_ap_CS_fsm_state1() {
    ap_CS_fsm_state1 = ap_CS_fsm.read()[0];
}

void store_bias_5::thread_ap_CS_fsm_state7() {
    ap_CS_fsm_state7 = ap_CS_fsm.read()[6];
}

void store_bias_5::thread_ap_CS_fsm_state8() {
    ap_CS_fsm_state8 = ap_CS_fsm.read()[7];
}

void store_bias_5::thread_ap_CS_fsm_state9() {
    ap_CS_fsm_state9 = ap_CS_fsm.read()[8];
}

void store_bias_5::thread_ap_block_state8() {
...
void store_bias_5::thread_ap_done() {
...
void store_bias_5::thread_ap_idle() {
    if ((esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
...
void store_bias_5::thread_ap_ready() {
...
void store_bias_5::thread_ap_sig_ioackin_m_axi_bias_ARREADY() {
...
void store_bias_5::thread_bias_blk_n_AR() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
...
void store_bias_5::thread_bias_blk_n_R() {
...
void store_bias_5::thread_bias_oc_address0() {
    bias_oc_address0 =  (sc_lv<7>) (tmp_fu_106_p1.read());
}

void store_bias_5::thread_bias_oc_ce0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
...
void store_bias_5::thread_bias_oc_d0() {
    bias_oc_d0 = bias_addr_read_reg_125.read();
}

void store_bias_5::thread_bias_oc_we0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
...
void store_bias_5::thread_exitcond_fu_94_p2() {
    exitcond_fu_94_p2 = (!i_reg_71.read().is_01() || !ap_const_lv7_78.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_71.read() == ap_const_lv7_78);
}

void store_bias_5::thread_i_6_fu_100_p2() {
    i_6_fu_100_p2 = (!i_reg_71.read().is_01() || !ap_const_lv7_1.is_01())? sc_lv<7>(): (sc_biguint<7>(i_reg_71.read()) + sc_biguint<7>(ap_const_lv7_1));
}

void store_bias_5::thread_m_axi_bias_ARADDR() {
    m_axi_bias_ARADDR =  (sc_lv<32>) (sext_fu_83_p1.read());
}

void store_bias_5::thread_m_axi_bias_ARBURST() {
    m_axi_bias_ARBURST = ap_const_lv2_0;
}

void store_bias_5::thread_m_axi_bias_ARCACHE() {
    m_axi_bias_ARCACHE = ap_const_lv4_0;
}

void store_bias_5::thread_m_axi_bias_ARID() {
    m_axi_bias_ARID = ap_const_lv1_0;
}

void store_bias_5::thread_m_axi_bias_ARLEN() {
    m_axi_bias_ARLEN = ap_const_lv32_78;
}

void store_bias_5::thread_m_axi_bias_ARLOCK() {
    m_axi_bias_ARLOCK = ap_const_lv2_0;
}

void store_bias_5::thread_m_axi_bias_ARPROT() {
    m_axi_bias_ARPROT = ap_const_lv3_0;
}

void store_bias_5::thread_m_axi_bias_ARQOS() {
    m_axi_bias_ARQOS = ap_const_lv4_0;
}

void store_bias_5::thread_m_axi_bias_ARREGION() {
    m_axi_bias_ARREGION = ap_const_lv4_0;
}

void store_bias_5::thread_m_axi_bias_ARSIZE() {
    m_axi_bias_ARSIZE = ap_const_lv3_0;
}

void store_bias_5::thread_m_axi_bias_ARUSER() {
    m_axi_bias_ARUSER = ap_const_lv1_0;
}

void store_bias_5::thread_m_axi_bias_ARVALID() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1) && 
...
void store_bias_5::thread_m_axi_bias_AWADDR() {
    m_axi_bias_AWADDR = ap_const_lv32_0;
}

void store_bias_5::thread_m_axi_bias_AWBURST() {
    m_axi_bias_AWBURST = ap_const_lv2_0;
}

void store_bias_5::thread_m_axi_bias_AWCACHE() {
    m_axi_bias_AWCACHE = ap_const_lv4_0;
}

void store_bias_5::thread_m_axi_bias_AWID() {
    m_axi_bias_AWID = ap_const_lv1_0;
}

void store_bias_5::thread_m_axi_bias_AWLEN() {
    m_axi_bias_AWLEN = ap_const_lv32_0;
}

void store_bias_5::thread_m_axi_bias_AWLOCK() {
    m_axi_bias_AWLOCK = ap_const_lv2_0;
}

void store_bias_5::thread_m_axi_bias_AWPROT() {
    m_axi_bias_AWPROT = ap_const_lv3_0;
}

void store_bias_5::thread_m_axi_bias_AWQOS() {
    m_axi_bias_AWQOS = ap_const_lv4_0;
}

void store_bias_5::thread_m_axi_bias_AWREGION() {
    m_axi_bias_AWREGION = ap_const_lv4_0;
}

void store_bias_5::thread_m_axi_bias_AWSIZE() {
    m_axi_bias_AWSIZE = ap_const_lv3_0;
}

void store_bias_5::thread_m_axi_bias_AWUSER() {
    m_axi_bias_AWUSER = ap_const_lv1_0;
}

void store_bias_5::thread_m_axi_bias_AWVALID() {
    m_axi_bias_AWVALID = ap_const_logic_0;
}

void store_bias_5::thread_m_axi_bias_BREADY() {
    m_axi_bias_BREADY = ap_const_logic_0;
}

void store_bias_5::thread_m_axi_bias_RREADY() {
    if ((!(esl_seteq<1,1,1>(exitcond_fu_94_p2.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(m_axi_bias_RVALID.read(), ap_const_logic_0)) && 
         esl_seteq<1,1,1>(exitcond_fu_94_p2.read(), ap_const_lv1_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()))) {
...
void store_bias_5::thread_m_axi_bias_WDATA() {
    m_axi_bias_WDATA = ap_const_lv32_0;
}

void store_bias_5::thread_m_axi_bias_WID() {
    m_axi_bias_WID = ap_const_lv1_0;
}

void store_bias_5::thread_m_axi_bias_WLAST() {
    m_axi_bias_WLAST = ap_const_logic_0;
}

void store_bias_5::thread_m_axi_bias_WSTRB() {
    m_axi_bias_WSTRB = ap_const_lv4_0;
}

void store_bias_5::thread_m_axi_bias_WUSER() {
    m_axi_bias_WUSER = ap_const_lv1_0;
}

void store_bias_5::thread_m_axi_bias_WVALID() {
    m_axi_bias_WVALID = ap_const_logic_0;
}

void store_bias_5::thread_sext_fu_83_p1() {
    sext_fu_83_p1 = esl_zext<64,30>(bias_offset.read());
}

void store_bias_5::thread_tmp_fu_106_p1() {
    tmp_fu_106_p1 = esl_zext<64,7>(i_reg_71.read());
}

void store_bias_5::thread_ap_NS_fsm() {
