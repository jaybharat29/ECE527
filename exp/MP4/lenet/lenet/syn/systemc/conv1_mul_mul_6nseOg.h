...
#ifndef __conv1_mul_mul_6nseOg__HH__
#define __conv1_mul_mul_6nseOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv1_mul_mul_6nseOg) {
    ...
    SC_CTOR(conv1_mul_mul_6nseOg):  ACMP_smul_us_U ("ACMP_smul_us_U") {
