...
#ifndef _store_bias_3_HH_
#define _store_bias_3_HH_
...
struct store_bias_3 : public sc_module {
    ...
    sc_out< sc_lv<4> > bias_oc_address0;
    ...
    // Module declarations
    store_bias_3(sc_module_name name);
    SC_HAS_PROCESS(store_bias_3);
    ...
    sc_signal< sc_lv<5> > i_7_fu_98_p2;
    sc_signal< sc_lv<5> > i_7_reg_118;
    sc_signal< bool > ap_block_state8;
    sc_signal< sc_lv<32> > bias_addr_read_reg_123;
    sc_signal< sc_lv<5> > i_reg_69;
    sc_signal< sc_logic > ap_CS_fsm_state7;
    sc_signal< sc_logic > ap_CS_fsm_state9;
    sc_signal< sc_lv<64> > tmp_fu_104_p1;
    sc_signal< sc_lv<64> > sext_fu_81_p1;
