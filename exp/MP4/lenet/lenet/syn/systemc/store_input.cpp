...
store_input::store_input(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_43_cast_fu_166_p1 );
    ...
    SC_METHOD(thread_tmp_16_fu_123_p1);
    sensitive << ( tmp_fu_115_p3 );

    SC_METHOD(thread_tmp_17_fu_127_p2);
    sensitive << ( sext_cast_reg_170 );
    sensitive << ( tmp_16_fu_123_p1 );

    SC_METHOD(thread_tmp_18_fu_132_p1);
    sensitive << ( tmp_17_reg_188 );

    SC_METHOD(thread_tmp_42_cast_fu_142_p1);
    sensitive << ( tmp_reg_183 );

    SC_METHOD(thread_tmp_43_cast_fu_166_p1);
    ...
    sc_trace(mVcdFile, tmp_17_fu_127_p2, "tmp_17_fu_127_p2");
    sc_trace(mVcdFile, tmp_17_reg_188, "tmp_17_reg_188");
    sc_trace(mVcdFile, ap_sig_ioackin_m_axi_input_r_ARREADY, "ap_sig_ioackin_m_axi_input_r_ARREADY");
    sc_trace(mVcdFile, tmp_42_cast_fu_142_p1, "tmp_42_cast_fu_142_p1");
    sc_trace(mVcdFile, tmp_42_cast_reg_199, "tmp_42_cast_reg_199");
    ...
    sc_trace(mVcdFile, tmp_43_cast_fu_166_p1, "tmp_43_cast_fu_166_p1");
    sc_trace(mVcdFile, tmp_18_fu_132_p1, "tmp_18_fu_132_p1");
    sc_trace(mVcdFile, ap_reg_ioackin_m_axi_input_r_ARREADY, "ap_reg_ioackin_m_axi_input_r_ARREADY");
    sc_trace(mVcdFile, tmp_16_fu_123_p1, "tmp_16_fu_123_p1");
...
void store_input::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(exitcond1_fu_103_p2.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
        tmp_17_reg_188 = tmp_17_fu_127_p2.read();
        tmp_reg_183 = tmp_fu_115_p3.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
        tmp_42_cast_reg_199 = tmp_42_cast_fu_142_p1.read();
    }
}
...
void store_input::thread_input_oc_0_address0() {
    input_oc_0_address0 =  (sc_lv<10>) (tmp_43_cast_fu_166_p1.read());
}
...
void store_input::thread_m_axi_input_r_ARADDR() {
    m_axi_input_r_ARADDR =  (sc_lv<32>) (tmp_18_fu_132_p1.read());
}
...
void store_input::thread_tmp_16_fu_123_p1() {
    tmp_16_fu_123_p1 = esl_zext<31,11>(tmp_fu_115_p3.read());
}

void store_input::thread_tmp_17_fu_127_p2() {
    tmp_17_fu_127_p2 = (!sext_cast_reg_170.read().is_01() || !tmp_16_fu_123_p1.read().is_01())? sc_lv<31>(): (sc_biguint<31>(sext_cast_reg_170.read()) + sc_biguint<31>(tmp_16_fu_123_p1.read()));
}

void store_input::thread_tmp_18_fu_132_p1() {
    tmp_18_fu_132_p1 = esl_zext<64,31>(tmp_17_reg_188.read());
}

void store_input::thread_tmp_42_cast_fu_142_p1() {
    tmp_42_cast_fu_142_p1 = esl_zext<12,11>(tmp_reg_183.read());
}

void store_input::thread_tmp_43_cast_fu_166_p1() {
    tmp_43_cast_fu_166_p1 = esl_zext<64,12>(tmp_s_reg_212.read());
}
...
void store_input::thread_tmp_s_fu_161_p2() {
    tmp_s_fu_161_p2 = (!tmp_42_cast_reg_199.read().is_01() || !tmp_cast_fu_157_p1.read().is_01())? sc_lv<12>(): (sc_biguint<12>(tmp_42_cast_reg_199.read()) + sc_biguint<12>(tmp_cast_fu_157_p1.read()));
}
