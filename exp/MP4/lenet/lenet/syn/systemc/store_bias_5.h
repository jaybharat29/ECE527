...
#ifndef _store_bias_5_HH_
#define _store_bias_5_HH_
...
struct store_bias_5 : public sc_module {
    ...
    sc_out< sc_lv<7> > bias_oc_address0;
    ...
    // Module declarations
    store_bias_5(sc_module_name name);
    SC_HAS_PROCESS(store_bias_5);
    ...
    sc_signal< sc_lv<7> > i_6_fu_100_p2;
    sc_signal< sc_lv<7> > i_6_reg_120;
    sc_signal< bool > ap_block_state8;
    sc_signal< sc_lv<32> > bias_addr_read_reg_125;
    sc_signal< sc_lv<7> > i_reg_71;
