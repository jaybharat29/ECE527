...
set C_modelName {relu_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ output_r float 32 regular {array 1600 { 2 3 } 1 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv1_fcmp_32ns_3dEe_U51", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "5153", "Max" : "5153"}
	, {"Name" : "Interval", "Min" : "5153", "Max" : "5153"}
]}
...
set Spec2ImplPortList { 
	output_r { ap_memory {  { output_r_address0 mem_address 1 11 }  { output_r_ce0 mem_ce 1 1 }  { output_r_we0 mem_we 1 1 }  { output_r_d0 mem_din 1 32 }  { output_r_q0 mem_dout 0 32 } } }
}
