set moduleName store_weights_3
...
set C_modelName {store_weights_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ weights float 32 regular {axi_master 0}  }
	{ weights_offset int 30 regular  }
	{ weights_oc float 32 regular {array 400 { 0 3 } 0 1 }  }
	{ input_channel int 4 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "weights", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "input_channel", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "weights_oc_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "weights_oc", "role": "address0" }} , 
 	...
 	{ "name": "input_channel", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "input_channel", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	weights_oc { ap_memory {  { weights_oc_address0 mem_address 1 9 }  { weights_oc_ce0 mem_ce 1 1 }  { weights_oc_we0 mem_we 1 1 }  { weights_oc_d0 mem_din 1 32 } } }
	input_channel { ap_none {  { input_channel in_data 0 4 } } }
}
