...
set C_modelName {store_bias}
set C_modelType { void 0 }
set C_modelArgList {
	{ bias float 32 regular {axi_master 0}  }
	{ bias_offset int 30 regular  }
	{ bias_oc float 32 regular {array 6 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ bias_oc_address0 sc_out sc_lv 3 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bias_oc_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "bias_oc", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	...
	bias_oc { ap_memory {  { bias_oc_address0 mem_address 1 3 }  { bias_oc_ce0 mem_ce 1 1 }  { bias_oc_we0 mem_we 1 1 }  { bias_oc_d0 mem_din 1 32 } } }
}
