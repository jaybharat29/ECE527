...
module AESL_axi_master_DATA_WEIGHT (
    clk,
    reset,
    TRAN_DATA_WEIGHT_AWVALID,
    TRAN_DATA_WEIGHT_AWREADY,
    TRAN_DATA_WEIGHT_AWADDR,
    TRAN_DATA_WEIGHT_AWID,
    TRAN_DATA_WEIGHT_AWLEN,
    TRAN_DATA_WEIGHT_AWSIZE,
    TRAN_DATA_WEIGHT_AWBURST,
    TRAN_DATA_WEIGHT_AWLOCK,
    TRAN_DATA_WEIGHT_AWCACHE,
    TRAN_DATA_WEIGHT_AWPROT,
    TRAN_DATA_WEIGHT_AWQOS,
    TRAN_DATA_WEIGHT_AWREGION,
    TRAN_DATA_WEIGHT_AWUSER,
    TRAN_DATA_WEIGHT_WVALID,
    TRAN_DATA_WEIGHT_WREADY,
    TRAN_DATA_WEIGHT_WDATA,
    TRAN_DATA_WEIGHT_WSTRB,
    TRAN_DATA_WEIGHT_WLAST,
    TRAN_DATA_WEIGHT_WID,
    TRAN_DATA_WEIGHT_WUSER,
    TRAN_DATA_WEIGHT_ARVALID,
    TRAN_DATA_WEIGHT_ARREADY,
    TRAN_DATA_WEIGHT_ARADDR,
    TRAN_DATA_WEIGHT_ARID,
    TRAN_DATA_WEIGHT_ARLEN,
    TRAN_DATA_WEIGHT_ARSIZE,
    TRAN_DATA_WEIGHT_ARBURST,
    TRAN_DATA_WEIGHT_ARLOCK,
    TRAN_DATA_WEIGHT_ARCACHE,
    TRAN_DATA_WEIGHT_ARPROT,
    TRAN_DATA_WEIGHT_ARQOS,
    TRAN_DATA_WEIGHT_ARREGION,
    TRAN_DATA_WEIGHT_ARUSER,
    TRAN_DATA_WEIGHT_RVALID,
    TRAN_DATA_WEIGHT_RREADY,
    TRAN_DATA_WEIGHT_RDATA,
    TRAN_DATA_WEIGHT_RLAST,
    TRAN_DATA_WEIGHT_RID,
    TRAN_DATA_WEIGHT_RUSER,
    TRAN_DATA_WEIGHT_RRESP,
    TRAN_DATA_WEIGHT_BVALID,
    TRAN_DATA_WEIGHT_BREADY,
    TRAN_DATA_WEIGHT_BRESP,
...
//------------------------Parameter----------------------
`define TV_IN_DATA_WEIGHT "../tv/cdatafile/c.conv1.autotvin_DATA_WEIGHT.dat"
`define TV_OUT_DATA_WEIGHT "../tv/rtldatafile/rtl.conv1.autotvout_DATA_WEIGHT.dat"
 parameter DATA_WEIGHT_ADDR_BITWIDTH = 32'd 32;
 parameter DATA_WEIGHT_AWUSER_BITWIDTH = 32'd 1;
 parameter DATA_WEIGHT_DATA_BITWIDTH = 32'd 32;
 parameter DATA_WEIGHT_WUSER_BITWIDTH = 32'd 1;
 parameter DATA_WEIGHT_ID_BITWIDTH = 32'd 1;
 parameter DATA_WEIGHT_RUSER_BITWIDTH = 32'd 1;
 parameter DATA_WEIGHT_BUSER_BITWIDTH = 32'd 1;
...
input clk;
input reset;
input  TRAN_DATA_WEIGHT_AWVALID;
output  TRAN_DATA_WEIGHT_AWREADY;
input [DATA_WEIGHT_ADDR_BITWIDTH - 1 : 0] TRAN_DATA_WEIGHT_AWADDR;
input [DATA_WEIGHT_ID_BITWIDTH - 1 : 0] TRAN_DATA_WEIGHT_AWID;
input [8 - 1 : 0] TRAN_DATA_WEIGHT_AWLEN;
input [3 - 1 : 0] TRAN_DATA_WEIGHT_AWSIZE;
input [2 - 1 : 0] TRAN_DATA_WEIGHT_AWBURST;
input [2 - 1 : 0] TRAN_DATA_WEIGHT_AWLOCK;
input [4 - 1 : 0] TRAN_DATA_WEIGHT_AWCACHE;
input [3 - 1 : 0] TRAN_DATA_WEIGHT_AWPROT;
input [4 - 1 : 0] TRAN_DATA_WEIGHT_AWQOS;
input [4 - 1 : 0] TRAN_DATA_WEIGHT_AWREGION;
input [DATA_WEIGHT_AWUSER_BITWIDTH - 1 : 0] TRAN_DATA_WEIGHT_AWUSER;
input  TRAN_DATA_WEIGHT_WVALID;
output  TRAN_DATA_WEIGHT_WREADY;
input [DATA_WEIGHT_DATA_BITWIDTH - 1 : 0] TRAN_DATA_WEIGHT_WDATA;
input [DATA_WEIGHT_DATA_BITWIDTH/8 - 1 : 0] TRAN_DATA_WEIGHT_WSTRB;
input  TRAN_DATA_WEIGHT_WLAST;
input  TRAN_DATA_WEIGHT_WID;
input [DATA_WEIGHT_WUSER_BITWIDTH - 1 : 0] TRAN_DATA_WEIGHT_WUSER;
input  TRAN_DATA_WEIGHT_ARVALID;
output  TRAN_DATA_WEIGHT_ARREADY;
input [DATA_WEIGHT_ADDR_BITWIDTH - 1 : 0] TRAN_DATA_WEIGHT_ARADDR;
input [DATA_WEIGHT_ID_BITWIDTH - 1 : 0] TRAN_DATA_WEIGHT_ARID;
input [8 - 1 : 0] TRAN_DATA_WEIGHT_ARLEN;
input [3 - 1 : 0] TRAN_DATA_WEIGHT_ARSIZE;
input [2 - 1 : 0] TRAN_DATA_WEIGHT_ARBURST;
input [2 - 1 : 0] TRAN_DATA_WEIGHT_ARLOCK;
input [4 - 1 : 0] TRAN_DATA_WEIGHT_ARCACHE;
input [3 - 1 : 0] TRAN_DATA_WEIGHT_ARPROT;
input [4 - 1 : 0] TRAN_DATA_WEIGHT_ARQOS;
input [4 - 1 : 0] TRAN_DATA_WEIGHT_ARREGION;
input  TRAN_DATA_WEIGHT_ARUSER;
output  TRAN_DATA_WEIGHT_RVALID;
input  TRAN_DATA_WEIGHT_RREADY;
output [DATA_WEIGHT_DATA_BITWIDTH - 1 : 0] TRAN_DATA_WEIGHT_RDATA;
output  TRAN_DATA_WEIGHT_RLAST;
output [DATA_WEIGHT_ID_BITWIDTH - 1 : 0] TRAN_DATA_WEIGHT_RID;
output [DATA_WEIGHT_RUSER_BITWIDTH - 1 : 0] TRAN_DATA_WEIGHT_RUSER;
output [2 - 1 : 0] TRAN_DATA_WEIGHT_RRESP;
output  TRAN_DATA_WEIGHT_BVALID;
input  TRAN_DATA_WEIGHT_BREADY;
output [2 - 1 : 0] TRAN_DATA_WEIGHT_BRESP;
...
// Inner signals
// AW request fifo
reg    [DATA_WEIGHT_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [DATA_WEIGHT_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [DATA_WEIGHT_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [DATA_WEIGHT_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [DATA_WEIGHT_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [DATA_WEIGHT_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg [DATA_WEIGHT_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
...
reg [DATA_WEIGHT_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [DATA_WEIGHT_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [DATA_WEIGHT_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_DATA_WEIGHT_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_DATA_WEIGHT_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_DATA_WEIGHT_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_DATA_WEIGHT_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_DATA_WEIGHT_BRESP = BRESP_tmp;
assign TRAN_DATA_WEIGHT_RDATA = RDATA_tmp;
assign TRAN_DATA_WEIGHT_RRESP = RRESP_tmp;
...
initial begin : initialize_DATA_WEIGHT_mem
  integer i;
  for (i = 0; i < DATA_WEIGHT_mem_depth; i = i + 1) begin
      DATA_WEIGHT_mem_0[i] = 0;
      DATA_WEIGHT_mem_1[i] = 0;
      DATA_WEIGHT_mem_2[i] = 0;
  end
end
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_DATA_WEIGHT_AWREADY & TRAN_DATA_WEIGHT_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_DATA_WEIGHT_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_DATA_WEIGHT_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_DATA_WEIGHT_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_DATA_WEIGHT_AWBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_DATA_WEIGHT_ARREADY & TRAN_DATA_WEIGHT_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_DATA_WEIGHT_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_DATA_WEIGHT_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_DATA_WEIGHT_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_DATA_WEIGHT_ARBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_DATA_WEIGHT_WREADY & TRAN_DATA_WEIGHT_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_DATA_WEIGHT_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_DATA_WEIGHT_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_DATA_WEIGHT_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_DATA_WEIGHT_AWVALID && TRAN_DATA_WEIGHT_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_DATA_WEIGHT_ARVALID && TRAN_DATA_WEIGHT_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_DATA_WEIGHT_WVALID && TRAN_DATA_WEIGHT_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_DATA_WEIGHT_WVALID && TRAN_DATA_WEIGHT_WREADY && TRAN_DATA_WEIGHT_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_DATA_WEIGHT_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_DATA_WEIGHT_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [DATA_WEIGHT_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [DATA_WEIGHT_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [DATA_WEIGHT_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > DATA_WEIGHT_mem_depth) begin
                $display ("C:/Users/Patel/Downloads/ECE527/exp/MP4/lenet/lenet/sim/verilog/AESL_axi_master_DATA_WEIGHT.v: Write request address %d exceed AXI master DATA_WEIGHT array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, DATA_WEIGHT_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = DATA_WEIGHT_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = DATA_WEIGHT_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = DATA_WEIGHT_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : DATA_WEIGHT_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : DATA_WEIGHT_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : DATA_WEIGHT_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = DATA_WEIGHT_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = DATA_WEIGHT_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = DATA_WEIGHT_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : DATA_WEIGHT_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : DATA_WEIGHT_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : DATA_WEIGHT_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > DATA_WEIGHT_mem_depth) begin
                $display ("C:/Users/Patel/Downloads/ECE527/exp/MP4/lenet/lenet/sim/verilog/AESL_axi_master_DATA_WEIGHT.v: Read request address %d exceed AXI master DATA_WEIGHT array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, DATA_WEIGHT_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= DATA_WEIGHT_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= DATA_WEIGHT_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= DATA_WEIGHT_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_DATA_WEIGHT_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= DATA_WEIGHT_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= DATA_WEIGHT_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= DATA_WEIGHT_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  integer mem_page; 
  integer DATA_WEIGHT_bitwidth; 
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [DATA_WEIGHT_C_DATA_BITWIDTH - 1 : 0] token_tmp; 
  reg [DATA_WEIGHT_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  DATA_WEIGHT_bitwidth = DATA_WEIGHT_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (DATA_WEIGHT_bitwidth , factor);
  fp = $fopen(`TV_IN_DATA_WEIGHT,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_DATA_WEIGHT); 
      $finish; 
  end 
  token = read_token(fp); 
