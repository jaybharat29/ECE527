...
$(ObjDir)/lenet_tb.cpp_pre.cpp.tb.o : lenet_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling lenet_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/lenet_gold.cpp_pre.cpp.tb.o : lenet_gold.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling lenet_gold.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/lenet_acc.cpp_pre.cpp.tb.o : lenet_acc.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling lenet_acc.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
