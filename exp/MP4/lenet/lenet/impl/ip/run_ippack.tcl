...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_CTL m_axi_DATA_INPUT m_axi_DATA_WEIGHT m_axi_DATA_BIAS m_axi_DATA_OUTPUT"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_DATA_INPUT {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_DATA_INPUT"
        data_width "32"
        param_prefix "C_M_AXI_DATA_INPUT"
    ...
    m_axi_DATA_WEIGHT {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_DATA_WEIGHT"
        data_width "32"
        param_prefix "C_M_AXI_DATA_WEIGHT"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_DATA_OUTPUT {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_DATA_OUTPUT"
        data_width "32"
        param_prefix "C_M_AXI_DATA_OUTPUT"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 2115980 II x}
