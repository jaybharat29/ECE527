...
wire   [4:0] i_7_fu_98_p2;
reg   [4:0] i_7_reg_118;
reg    ap_block_state8;
reg   [31:0] bias_addr_read_reg_123;
reg   [4:0] i_reg_69;
wire    ap_CS_fsm_state7;
wire    ap_CS_fsm_state9;
wire   [63:0] tmp_fu_104_p1;
wire   [63:0] sext_fu_81_p1;
...
always @ (posedge ap_clk) begin
    if ((~((exitcond_fu_92_p2 == 1'd0) & (m_axi_bias_RVALID == 1'b0)) & (exitcond_fu_92_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
        bias_addr_read_reg_123 <= m_axi_bias_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if ((~((exitcond_fu_92_p2 == 1'd0) & (m_axi_bias_RVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state8))) begin
        i_7_reg_118 <= i_7_fu_98_p2;
    end
end

always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | (~((exitcond_fu_92_p2 == 1'd0) & (m_axi_bias_RVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state8) & (exitcond_fu_92_p2 == 1'd1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((~((exitcond_fu_92_p2 == 1'd0) & (m_axi_bias_RVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state8) & (exitcond_fu_92_p2 == 1'd1))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((exitcond_fu_92_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state8 : begin
            if ((~((exitcond_fu_92_p2 == 1'd0) & (m_axi_bias_RVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state8) & (exitcond_fu_92_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if ((~((exitcond_fu_92_p2 == 1'd0) & (m_axi_bias_RVALID == 1'b0)) & (exitcond_fu_92_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (*) begin
    ap_block_state8 = ((exitcond_fu_92_p2 == 1'd0) & (m_axi_bias_RVALID == 1'b0));
end

assign bias_oc_address0 = tmp_fu_104_p1;

assign bias_oc_d0 = bias_addr_read_reg_123;

assign exitcond_fu_92_p2 = ((i_reg_69 == 5'd16) ? 1'b1 : 1'b0);

assign i_7_fu_98_p2 = (i_reg_69 + 5'd1);

assign m_axi_bias_ARADDR = sext_fu_81_p1;
...
assign sext_fu_81_p1 = bias_offset;

assign tmp_fu_104_p1 = i_reg_69;

endmodule //store_bias_3
