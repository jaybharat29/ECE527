...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "partb.autotvin.dat"
	set constFileTvOut       "partb.autotvout.dat"
	set constFileHdlTvIn     "partb.autohdltvin.dat"
	set constFileHdlTvOut    "partb.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
