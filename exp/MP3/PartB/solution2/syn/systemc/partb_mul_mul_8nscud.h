...
#ifndef __partb_mul_mul_8nscud__HH__
#define __partb_mul_mul_8nscud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(partb_mul_mul_8nscud) {
    ...
    SC_CTOR(partb_mul_mul_8nscud):  ACMP_smul_us_U ("ACMP_smul_us_U") {
