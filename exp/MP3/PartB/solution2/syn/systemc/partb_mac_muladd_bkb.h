...
#ifndef __partb_mac_muladd_bkb__HH__
#define __partb_mac_muladd_bkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(partb_mac_muladd_bkb) {
    ...
    SC_CTOR(partb_mac_muladd_bkb):  simcore_mac_0_U ("simcore_mac_0_U") {
