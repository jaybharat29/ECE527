...
// tvout file define: "C"
#define AUTOTB_TVOUT_PC_C  "../tv/rtldatafile/rtl.partb.autotvout_C.dat"
			...
			// bitslice(31, 0)
			{
				// celement: mB(31, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						...
						// ori_name              : mB
						// sub_1st_elem          : 
						// ori_name_1st_elem     : mB
						// regulate_c_name       : mB
						// input_type_conversion : mB
