...
#ifndef __parta1_2_mul_mul_cud__HH__
#define __parta1_2_mul_mul_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(parta1_2_mul_mul_cud) {
    ...
    SC_CTOR(parta1_2_mul_mul_cud):  ACMP_smul_us_U ("ACMP_smul_us_U") {
