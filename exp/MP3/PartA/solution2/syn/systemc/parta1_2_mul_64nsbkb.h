...
#ifndef __parta1_2_mul_64nsbkb__HH__
#define __parta1_2_mul_64nsbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(parta1_2_mul_64nsbkb) {
    ...
    SC_CTOR(parta1_2_mul_64nsbkb):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
