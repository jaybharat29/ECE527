...
#ifndef __parta1_2_mac_muladEe__HH__
#define __parta1_2_mac_muladEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(parta1_2_mac_muladEe) {
    ...
    SC_CTOR(parta1_2_mac_muladEe):  simcore_mac_0_U ("simcore_mac_0_U") {
