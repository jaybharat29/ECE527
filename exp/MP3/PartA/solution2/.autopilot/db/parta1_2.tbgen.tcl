set C_TypeInfoList {{ 
"parta1_2" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"A": [[], {"array": [ {"array": [ {"scalar": "int"}, [100]]}, [100]]}] }, {"B": [[], {"array": [ {"array": [ {"scalar": "int"}, [100]]}, [100]]}] }, {"C": [[], {"array": [ {"array": [ {"scalar": "int"}, [100]]}, [100]]}] }, {"mA": [[], {"scalar": "int"}] }, {"nA": [[], {"scalar": "int"}] }, {"mB": [[], {"scalar": "int"}] }, {"nB": [[], {"scalar": "int"}] }, {"mC": [[], {"scalar": "int"}] }, {"nC": [[], {"scalar": "int"}] }],[],""]
}}
set moduleName parta1_2
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.parta1_2_mul_64nsbkb_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.parta1_2_mul_mul_cud_U2", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.parta1_2_mac_muladEe_U3", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	parta1_2 {
		...
		C {Type IO LastRead 10 FirstWrite 11}
		...
		mC {Type I LastRead 1 FirstWrite -1}
