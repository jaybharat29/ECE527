...
if {[file isfile parta1_2.autotvin.dat]} {
	file delete -force parta1_2.autotvin.dat
}

if {[file isfile parta1_2.autotvout.dat]} {
	file delete -force parta1_2.autotvout.dat
}
