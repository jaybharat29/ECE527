...
if {[file isfile parta1_3.autotvin.dat]} {
	file delete -force parta1_3.autotvin.dat
}

if {[file isfile parta1_3.autotvout.dat]} {
	file delete -force parta1_3.autotvout.dat
}
