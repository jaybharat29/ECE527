...
if {[file isfile parta1_6.autotvin.dat]} {
	file delete -force parta1_6.autotvin.dat
}

if {[file isfile parta1_6.autotvout.dat]} {
	file delete -force parta1_6.autotvout.dat
}
