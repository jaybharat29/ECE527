...
if {[file isfile parta1_4.autotvin.dat]} {
	file delete -force parta1_4.autotvin.dat
}

if {[file isfile parta1_4.autotvout.dat]} {
	file delete -force parta1_4.autotvout.dat
}
