set C_TypeInfoList {{ 
"unop_mm" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"A": [[], {"array": [ {"scalar": "int"}, [10000]]}] }, {"B": [[], {"array": [ {"scalar": "int"}, [10000]]}] }, {"C": [[], {"array": [ {"scalar": "int"}, [10000]]}] }, {"mA": [[], {"scalar": "int"}] }, {"nA": [[], {"scalar": "int"}] }, {"mB": [[], {"scalar": "int"}] }, {"nB": [[], {"scalar": "int"}] }, {"mC": [[], {"scalar": "int"}] }, {"nC": [[], {"scalar": "int"}] }],[],""]
}}
set moduleName unop_mm
...
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "A","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 9999,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "C", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "C","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 9999,"step" : 1}]}]}]} , 
