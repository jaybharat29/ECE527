...
`define AUTOTB_DUT      unop_mm
`define AUTOTB_DUT_INST AESL_inst_unop_mm
`define AUTOTB_TOP      apatb_unop_mm_top
`define AUTOTB_LAT_RESULT_FILE "unop_mm.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "unop_mm.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_unop_mm_top
...
`define AUTOTB_TVIN_A  "./c.unop_mm.autotvin_A.dat"
`define AUTOTB_TVIN_B  "./c.unop_mm.autotvin_B.dat"
`define AUTOTB_TVIN_C  "./c.unop_mm.autotvin_C.dat"
`define AUTOTB_TVIN_nA  "./c.unop_mm.autotvin_nA.dat"
`define AUTOTB_TVIN_nB  "./c.unop_mm.autotvin_nB.dat"
`define AUTOTB_TVIN_mC  "./c.unop_mm.autotvin_mC.dat"
`define AUTOTB_TVIN_nC  "./c.unop_mm.autotvin_nC.dat"
`define AUTOTB_TVIN_A_out_wrapc  "./rtl.unop_mm.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "./rtl.unop_mm.autotvin_B.dat"
`define AUTOTB_TVIN_C_out_wrapc  "./rtl.unop_mm.autotvin_C.dat"
`define AUTOTB_TVIN_nA_out_wrapc  "./rtl.unop_mm.autotvin_nA.dat"
`define AUTOTB_TVIN_nB_out_wrapc  "./rtl.unop_mm.autotvin_nB.dat"
`define AUTOTB_TVIN_mC_out_wrapc  "./rtl.unop_mm.autotvin_mC.dat"
`define AUTOTB_TVIN_nC_out_wrapc  "./rtl.unop_mm.autotvin_nC.dat"
`define AUTOTB_TVOUT_C  "./c.unop_mm.autotvout_C.dat"
`define AUTOTB_TVOUT_C_out_wrapc  "./impl_rtl.unop_mm.autotvout_C.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.unop_mm.autotvout_C.dat", "r");
    fp2 = $fopen("./impl_rtl.unop_mm.autotvout_C.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.unop_mm.autotvout_C.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.unop_mm.autotvout_C.dat\"!");
    else begin
        $display("Comparing rtl.unop_mm.autotvout_C.dat with impl_rtl.unop_mm.autotvout_C.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
