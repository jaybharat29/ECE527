...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "unop_mm.autotvin.dat"
	set constFileTvOut       "unop_mm.autotvout.dat"
	set constFileHdlTvIn     "unop_mm.autohdltvin.dat"
	set constFileHdlTvOut    "unop_mm.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
