...
if {[file isfile parta1_5.autotvin.dat]} {
	file delete -force parta1_5.autotvin.dat
}

if {[file isfile parta1_5.autotvout.dat]} {
	file delete -force parta1_5.autotvout.dat
}
