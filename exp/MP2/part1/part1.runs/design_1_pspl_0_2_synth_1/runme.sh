...
HD_PWD='C:/Users/Patel/Downloads/ECE527/exp/MP2/part1/part1.runs/design_1_pspl_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_pspl_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_pspl_0_2.tcl
