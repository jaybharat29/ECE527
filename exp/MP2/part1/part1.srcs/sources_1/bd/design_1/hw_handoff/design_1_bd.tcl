...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set addra_0 [ create_bd_port -dir I -from 0 -to 0 addra_0 ]
  set clka_0 [ create_bd_port -dir I -type clk clka_0 ]
  set data_pmod_0 [ create_bd_port -dir O -from 511 -to 0 data_pmod_0 ]
  set dina_0 [ create_bd_port -dir I -from 511 -to 0 dina_0 ]
  set douta_0 [ create_bd_port -dir O -from 511 -to 0 douta_0 ]
  ...
  # Create instance: pspl_0, and set properties
  set pspl_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:pspl:1.0 pspl_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins pspl_0/S00_AXI]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pspl_0/s00_axi_aclk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net pspl_0_data_pmod [get_bd_ports data_pmod_0] [get_bd_pins pspl_0/data_pmod]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins pspl_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net wea_0_1 [get_bd_ports wea_0] [get_bd_pins blk_mem_gen_0/wea]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pspl_0/S00_AXI/S00_AXI_reg] SEG_pspl_0_S00_AXI_reg
