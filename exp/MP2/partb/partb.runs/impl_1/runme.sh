...
HD_PWD='C:/Users/nados/OneDrive/Documents/UIUC/Fall2018/ECE527/exp/MP2/partb/partb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log partb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source partb.tcl -notrace
